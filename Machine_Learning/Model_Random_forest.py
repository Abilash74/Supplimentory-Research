...
for k in range(kfold):
    ...
    # Convert labels from [1,2,3] → [0,1,2] for classification
...
for method in antagonistic_probs:
    ...
    # ===============================================================
# COMBINED ROC PLOT – Random Forest (Average Operator)
# Synergy + Antagonism Curves in One ACS-Style Figure
# ===============================================================
...
ax.set_title("ROC Curve – Random Forest (Average Operator)", fontsize=16, fontweight="bold")

# Grid + spine thickness
...
# Save the figure
fig.savefig("RF_ROC_Combined_Average.png", dpi=600, bbox_inches="tight")
